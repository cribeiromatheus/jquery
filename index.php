            ...
            <div class="row" id="email2">
                <div class="col" align="center">
                    <form action="#" method="post" id="noticias">
                        ...
                        <div class="col-md-3">
                            <input type="email" class="form-control" name="email-form" id="email-form" aria-describedby="emailHelpId" placeholder="seu@email.com">
                        </div>
                        <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright-text">
                            <p>Sublima Arts 2023 &copy; Todos os direitos reservados.
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div id="contato" class="visually-hidden">
                            <form action="" class="form">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="form-name" id="form-name" class="form-control" placeholder="Digite seu nome" aria-describedby="helpNome" required>
                                </div>
                                <div class="mb-3 required">
                                    <label for="form-email" class="form-label">Email: </label>
                                    <input type="email" name="form-email" id="form-email" class="form-control" placeholder="Digite seu email" aria-describedby="helpEmail" required>
                                </div>
                                <div class="mb-3 required">
